...
import diffusers
from diffusers import AutoencoderKL, DDPMScheduler, DiffusionPipeline, UNet2DConditionModel, StableDiffusionSAGPipeline
...
def main():
    ...
    for epoch in range(first_epoch, cfg.TRAIN.EPOCH):
        ...
        if accelerator.is_main_process:
            ...
            # create pipeline
            pipeline = StableDiffusionSAGPipeline.from_pretrained(
                cfg.MODEL.NAME,
